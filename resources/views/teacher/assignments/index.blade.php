...
<div class="adomx-table-card">
    <div class="adomx-table-header">
        <h3 class="adomx-table-title">All Assignments</h3>
    </div>
    
    <div style="padding: 0 25px 20px;">
        <form action="{{ route('teacher.assignments.index') }}" method="GET" style="display: flex; gap: 10px; align-items: center;">
        ...
        <table class="adomx-table">
            ...
            <tbody>
                @forelse($assignments as $assignment)
                    <tr>
                        <td><strong>{{ $assignment->student->name ?? 'N/A' }}</strong></td>
                        ...
                        <td>
                            <a href="{{ route('teacher.assignments.show', $assignment) }}" class="adomx-action-btn" title="View">
                ...
                @empty
                    <tr>
                        <td colspan="6" class="adomx-table-empty">No assignments found</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
