...
<div class="adomx-page-header">
    ...
    <div class="adomx-page-actions">
        <a href="{{ route('student.profile.edit') }}" class="adomx-btn adomx-btn-primary">
            ...
            <div class="adomx-card-body">
                ...
                <table class="adomx-info-table">
                    ...
                    <tr>
                        ...
                        <td><span class="adomx-status-badge adomx-status-student">Student</span></td>
                    </tr>
                    <tr>
            ...
            <div class="adomx-col-md-6">
                <div class="adomx-card">
                    <div class="adomx-card-body">
                        ...
                        <h2 style="color: var(--primary); margin: 10px 0;">{{ $user->courses()->count() }}</h2>
                        <a href="{{ route('student.courses.index') }}" class="adomx-btn adomx-btn-sm adomx-btn-primary">View All</a>
                    </div>
                </div>
            </div>
            <div class="adomx-col-md-6">
                <div class="adomx-card">
                    <div class="adomx-card-body">
                        <h4>Certificates</h4>
                        <h2 style="color: var(--primary); margin: 10px 0;">{{ $user->certificates()->count() }}</h2>
                        <a href="{{ route('student.certificates.index') }}" class="adomx-btn adomx-btn-sm adomx-btn-primary">View All</a>
                    </div>
                </div>
            </div>
        </div>
