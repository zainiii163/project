...
<div class="adomx-page-header">
    <div class="adomx-page-title">
        <h2>{{ isset($coupon) ? 'Edit' : 'Create' }} Coupon</h2>
    </div>
...
<div class="adomx-card">
    ...
    <div class="adomx-card-body">
        <form action="{{ isset($coupon) ? route('admin.payments.coupons.update', $coupon) : route('admin.payments.coupons.store') }}" method="POST">
            @csrf
            @if(isset($coupon))
                @method('PUT')
            @endif
