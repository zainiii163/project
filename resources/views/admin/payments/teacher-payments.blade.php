...
<div class="adomx-page-header">
    <div class="adomx-page-title">
        <h2>Payment History - {{ $teacher->name }}</h2>
    </div>
...
<div class="adomx-card" style="margin-bottom: 20px;">
    ...
    <div class="adomx-card-body">
        <div style="text-align: center; padding: 20px;">
            <div style="font-size: 36px; font-weight: bold; color: var(--success-color); margin-bottom: 10px;">
                ${{ number_format($totalEarnings, 2) }}
            </div>
            <div style="font-size: 14px; color: var(--text-secondary);">
                Total Teacher Earnings (70% commission)
            </div>
        </div>
    </div>
</div>
    ...
    <div class="adomx-table-container">
        <table class="adomx-table">
            ...
            <tbody>
                @forelse($payments as $payment)
                    <tr>
                        ...
                        <td style="color: var(--success-color); font-weight: bold;">
                            ${{ number_format($payment->total_price * 0.70, 2) }}
                        </td>
                        <td>
                ...
                @empty
                    <tr>
                        <td colspan="8" class="adomx-table-empty">No payments found</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
