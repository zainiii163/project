        ...
        <form action="{{ route('admin.coupons.update', $coupon) }}" method="POST">
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
                <div class="adomx-form-group">
                    ...
                    <input type="text" id="code" name="code" class="adomx-input @error('code') is-invalid @enderror" value="{{ old('code', $coupon->code) }}" required>
                    @error('code')
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
                <div class="adomx-form-group">
                    ...
                    <input type="number" id="value" name="value" class="adomx-input @error('value') is-invalid @enderror" value="{{ old('value', $coupon->value) }}" step="0.01" min="0" required>
                    @error('value')
                        <span class="adomx-error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="adomx-form-group">
                    ...
                    <input type="number" id="min_purchase" name="min_purchase" class="adomx-input @error('min_purchase') is-invalid @enderror" value="{{ old('min_purchase', $coupon->min_purchase) }}" step="0.01" min="0">
                    @error('min_purchase')
                        <span class="adomx-error">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
                <div class="adomx-form-group">
                    ...
                    <input type="number" id="max_uses" name="max_uses" class="adomx-input @error('max_uses') is-invalid @enderror" value="{{ old('max_uses', $coupon->max_uses) }}" min="1">
                    @error('max_uses')
                        <span class="adomx-error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="adomx-form-group">
                    ...
                    <input type="date" id="valid_from" name="valid_from" class="adomx-input @error('valid_from') is-invalid @enderror" value="{{ old('valid_from', $coupon->valid_from ? $coupon->valid_from->format('Y-m-d') : '') }}">
                    @error('valid_from')
                        <span class="adomx-error">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
                <div class="adomx-form-group">
                    ...
                    <input type="date" id="valid_until" name="valid_until" class="adomx-input @error('valid_until') is-invalid @enderror" value="{{ old('valid_until', $coupon->valid_until ? $coupon->valid_until->format('Y-m-d') : '') }}">
                    @error('valid_until')
                        <span class="adomx-error">{{ $message }}</span>
                    @enderror
                </div>
