        ...
        <form action="{{ route('admin.quizzes.store') }}" method="POST">
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px;">
                <div class="adomx-form-group">
                    ...
                    <input type="number" id="pass_score" name="pass_score" class="adomx-input @error('pass_score') is-invalid @enderror" value="{{ old('pass_score', 70) }}" min="0" max="100" required>
                    @error('pass_score')
                        <span class="adomx-error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="adomx-form-group">
                    ...
                    <input type="number" id="time_limit" name="time_limit" class="adomx-input @error('time_limit') is-invalid @enderror" value="{{ old('time_limit') }}" min="0">
                    @error('time_limit')
                        <span class="adomx-error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="adomx-form-group">
                    ...
                    <input type="number" id="max_attempts" name="max_attempts" class="adomx-input @error('max_attempts') is-invalid @enderror" value="{{ old('max_attempts') }}" min="0">
                    @error('max_attempts')
                        <span class="adomx-error">{{ $message }}</span>
                    @enderror
                </div>
